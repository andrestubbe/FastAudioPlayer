# FastAudioPlayer 0.1.2 [ALPHA-2026-08] — High-Performance Native Audio Engine for Java
...
```java
import fastaudioplayer.*;

public class Demo {
    public static void main(String[] args) {
        System.out.println("FastAudioPlayer 0.1.2 initialized.");
    }
}
```
